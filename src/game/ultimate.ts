...
export const ULTIMATE_COST = 20000;
export const ULTIMATE_REQUIRED = ['super-archer','super-warrior','super-mage','super-priest'] as const;
export const ULTIMATE_SKILLS = [
    { name: '무극 광폭화', description: '10초 주기, 6초간 자신의 공격력·공격속도 3배.' },
    { name: '천상 지배', description: '전투 중 자신을 포함한 모든 타워의 공격력·공격속도 +50%. 사제 축복과 중복되지 않고 더 강한 효과 적용.' },
    { name: '무극·천지개벽', description: '첫 적 등장 시, 이후 12초마다 전장 전체에 현재 공격력 12배의 방어 무시 피해. 보스 피해 추가 2배.' },
] as const;

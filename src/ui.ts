...
export function createUi(sim: GameSimulation, persistProgress = true): UiHandle {
  ...
  <footer><span>${icon('moon')} 달빛 수호대</span><p>Q 소환 <i>·</i> W 고급 <i>·</i> A 전설 <i>·</i> E 결계 <i>·</i> Space 일시정지</p><span>성장 기록 자동 저장</span></footer>
    ...
    button('help-button', () => open('help', heading('플레이 가이드', '운명은 뽑고, 전술은 고르세요', '소환 · 배치 · 합성, 세 가지로 시작하는 달빛의 전투') + `<div class="guide-list"><article><b>01</b><div><h3>수호자를 모으세요</h3><p>시작 수호자 3명이 배치되어 있습니다. 소환은 세 종류입니다. 수호자 소환은 일반~영웅, 고급 소환은 고급~신화, 전설 소환은 에픽~불멸에 더해 유니크가 드물게 나옵니다. 위로 갈수록 비쌉니다.</p></div></article><article><b>02</b><div><h3>길목을 지키세요</h3><p>수호자를 드래그해 이동합니다. 클릭하면 사거리가 보입니다. 기사·마법사·사제를 함께 편성하면 공격력 +15%.</p></div></article><article><b>03</b><div><h3>합성하고, 결계를 펼치세요</h3><p>같은 수호자 3명을 합성하면 상위 등급을 직접 고릅니다. 달빛 결계는 현재 적을 3초간 얼립니다. 기본 재사용 24초. 선택한 타워는 골드로 공격력 룰렛 또는 공격속도 룰렛 강화(+0.2~5%)를 강화합니다. 합성 시 수치가 계승됩니다. 슈퍼유니크 각성에는 같은 유형 유니크 1명·전설/신화/초월/불멸 각 3명과 40,000G가 필요합니다.</p></div></article><article><b>04</b><div><h3>네 난이도의 120웨이브와 보스를 돌파하세요</h3><p>보통 → 나이트메어 → 헬 → Insane 순서로 각각 120웨이브를 진행합니다. 난이도 전환 시 수호대와 강화가 유지됩니다. 보통 대비 적 체력·방어력은 나이트메어 +50%(1.5배), 헬 +100%(2배), Insane +200%(3배)이며 Insane은 등장 수가 2배입니다. 최대 수호대는 200명입니다. 적은 순환 경로를 돌고, 제한시간 종료 시 생존한 일반 적 6명당 체력 1, 보스당 5를 잃습니다. 보스는 웨이브가 아니라 <b>웨이브 사이의 별도 단계</b>입니다. 120웨이브는 전부 일반 웨이브이고, 5웨이브를 마칠 때마다 중간보스, 10웨이브마다 보스, 20웨이브마다 진보스가 이어서 등장하며 마지막 120웨이브 뒤에 최종보스가 강림합니다. 보스 단계는 웨이브 번호를 올리지 않습니다. 공략 제한시간은 각각 60초·95초·115초·135초이고, 50웨이브를 넘어서면 중간보스·보스·진보스가 20초씩 더 받습니다. 10웨이브마다 25종 중 무작위 축복 3개를 제시하며, 하나를 골라 주사위로 강화량을 정합니다. 실패해도 성장 조각은 남습니다.</p></div></article></div><button data-close class="dialog-primary">이제 지킬 준비가 됐어요</button>`));
